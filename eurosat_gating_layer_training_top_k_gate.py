...
server_pretrain_gate(strict_cnn, train_loader, device, num_epochs=15, lam_gate=1.0)
...
global_model = federated_head_finetune(path_clients, global_model, device, num_rounds=3)
